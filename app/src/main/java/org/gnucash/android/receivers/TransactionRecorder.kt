...
class TransactionRecorder : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (accountUID != null) {
            ...
            var amountBigDecimal: BigDecimal
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                amountBigDecimal = args.getSerializable<BigDecimal>(Transaction.EXTRA_AMOUNT, BigDecimal::class.java)!!
            } else {
                amountBigDecimal = args.getSerializable(Transaction.EXTRA_AMOUNT) as BigDecimal
            }
            amountBigDecimal =
