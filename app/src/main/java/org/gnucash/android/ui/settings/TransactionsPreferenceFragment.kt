...
class TransactionsPreferenceFragment : GnuPreferenceFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        preferenceDouble.setOnPreferenceChangeListener { preference: Preference, newValue: Any? ->
        ...
        preferenceDelete.setOnPreferenceClickListener { preference: Preference ->
    ...
    fun showDeleteTransactionsDialog(context: Context) {
        ...
        if (shouldBackupTransactions(context)) {
            dialog.show(getParentFragmentManager(), "transaction_settings")
        } else {
