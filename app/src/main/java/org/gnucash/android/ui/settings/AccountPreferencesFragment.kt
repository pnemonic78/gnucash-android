...
class AccountPreferencesFragment : GnuPreferenceFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        listPreference.setOnPreferenceChangeListener { preference: Preference, newValue: Any? ->
    ...
    fun showDeleteAccountsDialog() {
        val dialog = DeleteAllAccountsConfirmationDialog()
        dialog.show(getParentFragmentManager(), "delete_accounts")
    }
