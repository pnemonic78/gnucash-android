...
class OwnCloudDialogFragment : VolatileDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        serverErrorText.visibility = View.GONE
        usernameErrorText.visibility = View.GONE
        directoryErrorText.visibility = View.GONE
    ...
    private fun checkData() {
        ...
        if (FileUtils.isValidPath(directory, false)) {
            ...
            directoryErrorText.visibility = View.VISIBLE
        } else {
            directoryErrorText.setTextColor(
            ...
            override fun onRemoteOperationFinish(
                ...
                if (result.isSuccess) {
                    if (caller is GetRemoteStatusOperation) {
                        ...
                        serverErrorText.visibility = View.VISIBLE
