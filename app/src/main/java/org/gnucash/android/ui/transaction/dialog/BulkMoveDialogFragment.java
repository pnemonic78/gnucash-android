...
public class BulkMoveDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        String[] whereArgs = new String[]{originAccountUID};

        final QualifiedAccountNameAdapter accountNameAdapter = new QualifiedAccountNameAdapter(context, where, whereArgs);
