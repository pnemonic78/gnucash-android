...
class RecurrenceViewClickListener(
    ...
    override fun onClick(v: View) {
        ...
        args.putLong(RecurrencePickerDialogFragment.BUNDLE_START_TIME_MILLIS, now.getTimeInMillis())
        ...
        var fragment = fragmentManager.findFragmentByTag(TAG_RECURRENCE_PICKER) as? RecurrencePickerDialogFragment
        fragment?.dismiss()
        fragment = RecurrencePickerDialogFragment()
