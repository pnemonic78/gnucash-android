...
class GeneralPreferenceFragment : GnuPreferenceFragment() {
    ...
    override fun onCreatePreferences(bundle: Bundle?, rootKey: String?) {
        ...
        preferenceTheme.setOnPreferenceChangeListener { preference: Preference, newValue: Any? ->
        ...
        preferencePasscode.setOnPreferenceChangeListener { preference: Preference, newValue: Any? ->
        ...
        preferencePasscodeChange.setOnPreferenceChangeListener { preference: Preference, newValue: Any? ->
            val context = preference.context
            val intent = Intent(context, PasscodePreferenceActivity::class.java)
    ...
    companion object {
         ...
         */
        const val PASSCODE_REQUEST_CODE: Int = 0x2

        /**
         * Request code for disabling passcode
         */
        const val REQUEST_DISABLE_PASSCODE: Int = 0x3

        /**
         * Request code for changing passcode
         */
        const val REQUEST_CHANGE_PASSCODE: Int = 0x4
    }
}
