...
class TransferFundsDialogFragment : VolatileDialogFragment() {
    ...
    private fun onCreateBinding(inflater: LayoutInflater): DialogTransferFundsBinding {
        ...
        binding.radioConvertedAmount.setOnCheckedChangeListener { buttonView, isChecked ->
        ...
        binding.radioExchangeRate.setOnCheckedChangeListener { buttonView, isChecked ->
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val binding = onCreateBinding(getLayoutInflater())
