...
class BackupPreferenceFragment : GnuPreferenceFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (preference.summaryProvider == null) {
            preference.setSummaryProvider { preference: Preference ->
        ...
        preference.setOnPreferenceClickListener { preference: Preference ->
            restoreBackup()
            true
        }
        ...
        switch.setOnPreferenceClickListener { preference: Preference ->
        ...
        switch = findPreference<TwoStatePreference>(getString(R.string.key_owncloud_sync))!!
        switch.setOnPreferenceClickListener { preference: Preference ->
    ...
    private fun toggleOwnCloudSync(preference: TwoStatePreference) {
        ...
        if (preferences.isSync) preferences.isSync = false
        else {
            val ocDialog = newInstance(preference)
