 ...
 */
class AccountsDbAdapter @JvmOverloads constructor(
    /**
    ...
    fun reassignDescendantAccounts(parentAccountUID: String, newParentAccountUID: String) {
        ...
        val descendantAccounts = getSimpleAccounts(
            AccountEntry.COLUMN_UID + " IN " + descendantAccountUIDs.joinToString(
                "','",
                prefix = "('",
                postfix = "')"
            ),
    ...
    fun recursiveDeleteAccount(accountUID: String): Boolean {
        ...
        try {
            ...
            val accountUIDList =
                descendantAccountUIDs.joinToString("','", prefix = "('", postfix = "')")
    ...
    private fun computeSplitsBalance(
        ...
        return if (accountType.hasDebitNormalBalance) balance else balance.unaryMinus()
    }
    ...
    fun getDescendantAccountUIDs(
        ...
        do {
            val cursor: Cursor? = db.query(
                tableName,
                projection,
                AccountEntry.COLUMN_PARENT_ACCOUNT_UID + " IN " + accountsLevel.joinToString(
                    "','",
                    prefix = "('",
                    postfix = "')"
                ) + whereAnd,
