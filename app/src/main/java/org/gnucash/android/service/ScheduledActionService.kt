...
class ScheduledActionService {
    ...
    private fun processScheduledBook(context: Context, book: Book) {
        ...
        val dbHelper = DatabaseHelper(context, book.getUID())
        ...
        val scheduledActions = scheduledActionDbAdapter.getAllEnabledScheduledActions()
        Timber.i(
        ...
        private fun executeScheduledEvent(
            ...
            if (executionCount > 0) {
                ...
                db.update(
                    ...
                    arrayOf<String>(scheduledAction.getUID())
                )
            }
        }
