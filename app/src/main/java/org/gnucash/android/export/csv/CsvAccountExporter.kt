 ...
 */
class CsvAccountExporter @JvmOverloads constructor(
    context: Context,
    params: ExportParams,
    bookUID: String,
    ...
    fun writeExport(writer: ICSVWriter) {
        ...
        val accounts = mAccountsDbAdapter.getSimpleAccounts(where, null, null)
        listener?.onAccountCount(accounts.size.toLong())

        val names = mContext.resources.getStringArray(R.array.csv_account_headers)
    ...
    private fun orEmpty(s: String?): String {
        return s ?: ""
    }
