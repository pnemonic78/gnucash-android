...
public abstract class Exporter {
     ...
     */
    @NonNull
    public static String buildExportFilename(ExportFormat format, String bookName, boolean isCompressed) {
     ...
     *
     * @param filename Export file name generated by {@link #buildExportFilename(ExportFormat, String, boolean)}
    ...
    protected String getExportCacheFilePath() {
        ...
        if (mExportCacheFilePath == null) {
            ...
            mExportCacheFilePath = cachePath + buildExportFilename(mExportParams.getExportFormat(), bookName, mExportParams.isCompressed);
        }
